...
exports.connect = require('./connect').handler;


exports.handleResourceRequest = function(transportName, request, callback) {
  var transport = require('./transports/' + transportName),
...
var discoverTransports = function() {
  ...
  exports.initializeTransport = function(transportName, server) {
    transports[transportName].init(server);
  };
};
discoverTransports();
