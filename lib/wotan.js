...
var configure = function(opts) {
  ...
  findResources(resourceDir);
  obj.forIn(resources, function(resourceName, resource) {
...
var findResources = function(resourceDir) {
  dir.forEachDirectory(resourceDir, function(dirname) {
    resources[dirname] = {
      name: dirname,
      path: path.join(resourceDir, dirname)
    };
  });
};
